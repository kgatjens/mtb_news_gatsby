  ...
  return new Promise((resolve, reject) => {
    ...
    graphql(
      ...
      .then(result => {
        ...
        const mtbContentTemplate = path.resolve("./src/templates/mtb_news.js")
    ...
    .then(() => {
      graphql(
        ...
        const newsTemplate = path.resolve("./src/templates/mtb_news.js")
        // We want to create a detailed page for each
        // post node. We'll just use the WordPress Slug for the slug.
        // The Post ID is prefixed with 'POST_'
        _.each(result.data.allWordpressWpMtbNews.edges, edge => {
          // console.log('---------');
          //   console.log(edge.node.title,edge.node.template);
          //   console.log('---------');
          createPage({
            path: `/mtb_news/${edge.node.slug}/`,
